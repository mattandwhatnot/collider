...
export default class DataState extends Component {
  ...
  render() {
    ...
    console.log(this.state.dtOneRaw, this.state.dtOneTabled, this.state.dtTwoRaw, this.state.dtTwoTabled, this.state.dtStretch );
      ...
      <div class='split'>
        <div class='splitOne'>
          ...
          <DataStretch
            ...
            outputData={linkState(this, 'dtStretch')} />
        </div>
        <div class='splitTwo'>
          <DataWorkerWrap
            name='table 1'
